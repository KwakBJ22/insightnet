...
export const portfolioDetails: Record<number, PortfolioDetail> = {
  1: {
    ...
    heroImage: '/images/portfolio-01.jpg',
    clientName: '프레시코리아',
    industry: '이커머스 / 리테일',
    duration: '2024.03 - 2024.09 (7개월)',
    overview:
    ...
    results: [
      { value: '2.1x', label: '전환율 증가' },
      { value: '1.2s', label: '평균 로딩 속도' },
      { value: '4', label: '서비스 국가' },
  ...
  2: {
    ...
    heroImage: '/images/portfolio-02.jpg',
    clientName: '메디컬AI 랩스',
    industry: '헬스케어 / 의료',
    duration: '2023.09 - 2024.06 (10개월)',
    overview:
    ...
    results: [
      ...
      { value: '1,500+', label: '일평균 분석 건수' },
      { value: '3', label: '도입 의료기관' },
  ...
  3: {
    ...
    heroImage: '/images/portfolio-03.jpg',
    clientName: '페이플래닛',
    industry: '핀테크 / 금융',
  ...
  4: {
    ...
    heroImage: '/images/portfolio-04.jpg',
    clientName: '한국정밀제조',
    industry: '제조 / 스마트팩토리',
    duration: '2023.06 - 2024.04 (11개월)',
    overview:
  ...
  5: {
    ...
    category: 'web',
    categoryLabel: 'Web Development',
    heroImage: '/images/portfolio-05.jpg',
    clientName: '비즈인사이트',
    industry: 'SaaS / B2B',
    duration: '2024.02 - 2024.07 (6개월)',
    overview:
    ...
    results: [
      { value: '50만+', label: '실시간 처리 행 수' },
      { value: '3x', label: '엔터프라이즈 계약 증가' },
  ...
  6: {
    ...
    category: 'app',
    categoryLabel: 'App Development',
    heroImage: '/images/portfolio-06.jpg',
    clientName: '스타일플러스',
    industry: '리테일 / 패션',
    duration: '2023.10 - 2024.05 (8개월)',
    overview:
